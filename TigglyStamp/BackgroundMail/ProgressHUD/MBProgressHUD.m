...
// NOTE: I disabled this for EAM because it resizes the HUD to fit the super
// view's bounds when the device orientation changes, which is problematic for
// us because sometimes we don't want the HUD to fit the entire screen (upon
// login), which will make the HUD jump up and down. We only support portrait
// mode anyway...
